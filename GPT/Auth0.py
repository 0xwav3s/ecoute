...
openai_email_input = (By.XPATH, '//input[@type="email"]')
openai_pwd_input = (By.NAME, 'password')
openai_pwd_label = (By.XPATH, "//label[normalize-space(text())='Password']")
openai_continue_btn = (By.XPATH, '//button[text()="Continue"]')
openai_continue_btn2 = (By.XPATH, '//*[text()="Continue"]')
...
def __openai_login(self, retry: int = 3) -> None:
    ...
    self.logger.debug('Entering password...')
    self.driver.refresh()
    self.driver.find_element(*openai_continue_btn2).click()
